...
namespace Negocio
{
    public class ArticulosNegocio
    {
        ...
        public bool GuardarSP(Articulo nuevo)
        {
            AccesoDatos datos = new AccesoDatos();
            ...
            try
            {
                ...
                datos.setearProcedimiento("GuardarArticulo");
        ...
        public int GuardarConImgSP(Articulo nuevo)
        {
            AccesoDatos datos = new AccesoDatos();

            try
            {
                // Cambiamos a la llamada al procedimiento almacenado
                datos.setearProcedimiento("GuardarConImgSP");
                ...
                // Ejecutamos la acción y obtenemos el id insertado
                return datos.ejecutarAccionScalar();  // ejecuta y retorna el id generado
            }
            catch (Exception)
            {
                throw;
        ...
        public bool EditarArticuloSP(Articulo nuevo)
        {
            AccesoDatos datos = new AccesoDatos();
            ...
            {
                // Cambiamos a la llamada al procedimiento almacenado
                datos.setearProcedimiento("EditarArticuloSP");
        ...
        public bool ActualizarImagenArticuloSP(int id, string imagenFinal)
        {
            AccesoDatos datos = new AccesoDatos();
            ...
            try
            {
                ...
                datos.setearProcedimiento("ActualizarImagenArticuloSP");
        ...
        public bool EliminarSP(int Id)
        {
            try
            {
                ...
                // Asignamos el parámetro necesario
                datos.setearParametro("@id", Id);
        ...
        public Articulo ListararticuloIdSP(string id = "")
        {
            Articulo articulo = new Articulo();
            AccesoDatos datos = new AccesoDatos();
            ...
            {
                // Llamamos al procedimiento almacenado
                datos.setearProcedimiento("ListarArticuloPorId");
        ...
        public bool EliminarFavoritoSP(int userId, int idArticulo)
        {
            bool operacionExitosa = false;
            AccesoDatos datos = new AccesoDatos();
            ...
            {
                // Llamamos al procedimiento almacenado
                datos.setearProcedimiento("EliminarFavorito");
                ...
                operacionExitosa = true; // Si no hay excepción, la operación es exitosa
            }
            catch (Exception ex)
            {
                Console.WriteLine("Error al eliminar favorito: " + ex.Message);
        ...
        public List<int> ObtenerFavoritosSP(int userId)
        {
            List<int> favoritos = new List<int>();
            AccesoDatos datos = new AccesoDatos();
            ...
            {
                // Llamamos al procedimiento almacenado
                datos.setearProcedimiento("ObtenerFavoritosPorUsuario");
                ...
                while (datos.Lector.Read())
                {
                    favoritos.Add(datos.Lector.GetInt32(0)); // Agregamos el IdArticulo a la lista
                }
            }
            catch (Exception ex)
            {
