<%@ Page Title="Marcas" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Marcas.aspx.cs" Inherits="Catalogo_Web.Marcas" %>
    ...
    <div class="row">
        ...
        <div class="col">
            ...
            <ul class="nav nav-tabs">
                <li class="nav-item">
                    <a class="nav-link" style="color: white; background-color: black; border: 2px black; border-bottom-color: black;" aria-current="page">Listado de Marcas</a>
                </li>
            </ul>
            ...
            <asp:GridView ID="dgvMarcass" DataKeyNames="Id"
                OnRowEditing="dgvMarcass_RowEditing"
                OnRowCancelingEdit="dgvMarcass_RowCancelingEdit"
                OnRowDeleting="dgvMarcass_RowDeleting"
                OnRowUpdating="dgvMarcass_RowUpdating"
